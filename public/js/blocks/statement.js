...
SirTrevor.Blocks.Statement = (function(){
  ...
  return SirTrevor.Block.extend({
    ...
    editorHTML: function() {
      var template = [
        '<div class="ui top right attached label"><i class="warning icon"></i> متن</div>',
        '<div class="field"><label>متن ثابت:</label>',
    ...
    validations: ['statementValidator'],

    // Example custom validator
    statementValidator: function() {
      var field = this.$('.st-text-block');
    ...
    toData: function(){
      ...
      var content = "salamsasas"; //this.getTextBlock().text();
