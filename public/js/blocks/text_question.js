/*
  Long text block for flow designer
  --
  Author: Morteza Ansarinia <ansarinia@me.com>
*/

SirTrevor.Blocks.TextQuestion = (function(){
  ...
  return SirTrevor.Block.extend({
    ...
    editorHTML: function() {
      var template = [
        '<div class="ui top right attached label"><i class="quote left icon"></i> سوال متنی</div>',
        '<div class="field">',
        ...
        '<div class="field">',
        '  <div class="ui checkbox">',
        '    <input type="checkbox" name="longAnswer">',
        '    <label>پاسخ چندخطی</label>',
        '  </div>',
        '</div>'
      ].join("\n");
      return template;
    ...
    validations: ['textQuestionValidator'],

    // validator
    textQuestionValidator: function() {
    ...
    loadData: function(data){
      ...
      this.$('input[name="longAnswer"]').prop('checked',data.longAnswer);
