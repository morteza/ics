/*
  Page break block for SirTrevor
  --
  Author: Morteza Ansarinia <ansarinia@me.com>
*/

SirTrevor.Blocks.PageBreak = (function(){
  ...
  return SirTrevor.Block.extend({
    ...
    editorHTML: function() {
      var template = [
        '<div class="ui top right attached label"><i class="file icon"></i> صفحه‌ی جدید</div>',
    ...
    validations: ['pageBreakValidator'],

    // Custom validator
    pageBreakValidator: function() {
    },
