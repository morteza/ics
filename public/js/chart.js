...
(function() {
	...
	Chart.defaults.global.tooltips = {
		...
		fontFamily: "'FarsiFont', 'Lato', 'Helvetica Neue', 'Helvetica', 'Arial', sans-serif",
		fontSize: 10,
		fontStyle: "normal",
		fontColor: "#fff",
		titleFontFamily: "'FarsiFont', 'Lato', 'Helvetica Neue', 'Helvetica', 'Arial', sans-serif",
		titleFontSize: 12,
		titleFontStyle: "bold",
		titleFontColor: "#fff",
		yPadding: 6,
...
(function() {
	...
	var defaultConfig = {
		...
		labels: {
			...
			fontStyle: "normal",
			fontColor: "#666",
			fontFamily: "'FarsiFont', 'Lato', 'Helvetica Neue'",
		},
	};
...
(function() {
	...
	var defaultConfig = {
		...
		pointLabels: {
			...
			fontFamily: "'FarsiFont', 'Lato', 'Arial'",
