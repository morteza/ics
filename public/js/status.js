...
(function($){	
	...
	$.status2html = function(JSON) {
        var str = "<h2>Status</h2>"
	      str += $.status2html.java(JSON);
    ...
    $.status2html.java = function(JSON) {
       var str = '<h3 class="ui dividing header">Java</h3>';
       str += "<ul>Version : <code>" + JSON["java"]["version"] + "</code></ul>";
    ...
    $.status2html.application = function(JSON) {
      var str = '<h3 class="ui dividing header">Application</h3>';
    ...
    $.status2html.pool = function(JSON) {
      var str = '<h3 class="ui dividing header">Pool</h3>';
    ...
    $.status2html.monitors = function(JSON) {
      var str = '<h3 class="ui dividing header">Monitors</h3>';

       str += "<table id='monitors' class='ui table'>";
       str += "<thead>";
       str += "<th>N°</th>";
       str += "<th>name</th>";
       str += "<th>avg</th>";
